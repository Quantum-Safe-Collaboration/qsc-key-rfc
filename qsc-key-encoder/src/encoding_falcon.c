...
#define FALCONXXX_CRYPTO_ASN1_PUBLICKEYBYTES(NAME) \
  ASN_TLLEN(FALCON_##NAME##_CRYPTO_PUBLICKEYBYTES) + \
  ASN_TLLEN(FALCON_##NAME##_H) + FALCON_##NAME##_H
...
#define FALCONXXX_CRYPTO_ASN1_SUBJECTPUBLICKEYINFOBYTES(NAME) \
  ASN_TLLEN(FALCONXXX_CRYPTO_ASN1_PUBLICKEYBYTES(NAME)) + \
  ASN_TLLEN(ASN_OIDLEN(QSC_ALGORITHM_SIG_FALCON_##NAME##_OID)) + \
  ASN_OIDLEN(QSC_ALGORITHM_SIG_FALCON_##NAME##_OID) + \
  ASN_TLLEN(0) + \
  ASN_TLLEN(FALCONXXX_CRYPTO_ASN1_PUBLICKEYBYTES(NAME)) + FALCONXXX_CRYPTO_ASN1_PUBLICKEYBYTES(NAME)
...
#define FALCONXXX_CRYPTO_ASN1_SECRETKEYBYTES(NAME) \
  ASN_TLLEN(FALCON_##NAME##_CRYPTO_SECRETKEYBYTES) + \
  ASN_TLLEN(1) + 1 + \
  ASN_TLLEN(FALCON_##NAME##_F) + FALCON_##NAME##_F + \
  ASN_TLLEN(FALCON_##NAME##_G) + FALCON_##NAME##_G + \
  ASN_TLLEN(FALCON_##NAME##_FF) + FALCON_##NAME##_FF + \
...
#define FALCONXXX_CRYPTO_ASN1_PRIVATEKEYINFOBYTES(NAME) \
  ASN_TLLEN(FALCONXXX_CRYPTO_ASN1_SECRETKEYBYTES(NAME)) + \
  ASN_TLLEN(1) + 1 + \
  ASN_TLLEN(ASN_OIDLEN(QSC_ALGORITHM_SIG_FALCON_##NAME##_OID)) + \
  ASN_OIDLEN(QSC_ALGORITHM_SIG_FALCON_##NAME##_OID) + \
  ASN_TLLEN(0) + \
  ASN_TLLEN(FALCONXXX_CRYPTO_ASN1_SECRETKEYBYTES(NAME)) + FALCONXXX_CRYPTO_ASN1_SECRETKEYBYTES(NAME)

#define FALCONXXX_CRYPTO_ASN1_PRIVATEKEYINFOBYTES_NOOPTIONAL(NAME) \
  ASN_TLLEN(FALCONXXX_CRYPTO_ASN1_SECRETKEYBYTES_NOOPTIONAL(NAME)) + \
  ASN_TLLEN(1) + 1 + \
  ASN_TLLEN(ASN_OIDLEN(QSC_ALGORITHM_SIG_FALCON_##NAME##_OID)) + \
  ASN_OIDLEN(QSC_ALGORITHM_SIG_FALCON_##NAME##_OID) + \
  ASN_TLLEN(0) + \
  ASN_TLLEN(FALCONXXX_CRYPTO_ASN1_SECRETKEYBYTES_NOOPTIONAL(NAME)) + FALCONXXX_CRYPTO_ASN1_SECRETKEYBYTES_NOOPTIONAL(NAME)
...
#define FALCON_ASNTLP_PK(NAME) \
  static const qsc_asntl_t FALCON_##NAME##_asntlp_pk[] = { \
      { \
          ...
          .asnlen = FALCONXXX_CRYPTO_ASN1_PUBLICKEYBYTES(NAME) - ASN_TLLEN(FALCONXXX_CRYPTO_ASN1_PUBLICKEYBYTES(NAME)), \
          .asnenc_flag = 1 \
      }, \
      { \
...
#define FALCON_ASNTLP_SK(NAME) \
  static const qsc_asntl_t FALCON_##NAME##_asntlp_sk[] = { \
      { \
          .asntag = ASN1_SEQUENCE, \
          .asnlen = FALCONXXX_CRYPTO_ASN1_SECRETKEYBYTES(NAME) - ASN_TLLEN(FALCONXXX_CRYPTO_ASN1_SECRETKEYBYTES(NAME)), \
          .asnenc_flag = 1, \
      }, \
      { \
          .asntag = ASN1_INT, \
